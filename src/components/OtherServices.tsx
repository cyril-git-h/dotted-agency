        ...
        <section data-aos='fade-up' className="section section--dark">
            <div className="container">
                <div data-aos='fade-up' className="section__item">
                    ...
                    <h1 className="section__title">Other services</h1>
                    <p className="section__text">The brand is not a logo. It’s not a font. It’s not even a name.</p>
                    <p className="section__text">The brand is the personality of the product you’re selling. It’s the tone of
                    voice and the sum of associations in your customers minds. It is everything that the product or
                    service represents, everything it stands for.</p>
                </div>
                <ul data-aos='fade-up' className="service-list">
